...
alias covidtest='python3 ~/Documents/covid-test-scheduler/schedule.py'
alias oem='cd ~/Documents/formula/olin-electric-motorsports'
alias aoc='cd ~/Documents/Advent\ of\ Code/2017'
alias scrot='escrotum -s'
alias softdes='cd ~/Documents/SoftDes/softdes-2022-01'
alias nvimconfig='nvim ~/.config/nvim/init.vim'
alias oscope='sudo MESA_LOADER_DRIVER_OVERRIDE=i965 O-Scope'
alias wordledir='cd ~/Documents/python/wordle'
alias vim='nvim'
alias canread='candump can0 python3 -m cantools decode bazel-bin/vehicle/mkv/mkv.dbc'
alias pysmash='cd ~/Documents/SoftDes/pysmash'
...
__conda_setup="$('/home/amit/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
